...
/**
 * This class read the data file from hdi-data.csv and upload the data to HBase running in the
 * local machine. 
 * 
 *
 */
public class HDIDataUploader {
    ...
    public static void main(String[] args) throws Exception {
	   ...
	   // config.set("hbase.master", "localhost:60020");
        ...
        BufferedReader reader = new BufferedReader(new FileReader("/home/cloudera/ebooks/Hbase/hdi-data.csv"));
